...
namespace MiscParseUtilities
{
    ...
    {
        #region constants
        public static uint[] CrcTableOffset32 =
            {
        ...
        public uint ComputeCRC(uint dwCRC, byte[] pv, uint cbLength)
        {
            ...
            for (i = 0; i < cbRunningLength / 8; ++i)
            {
                ...
                dw2nd32 = BitConverter.ToUInt32(pv, index);
                dwCRC = dwCRC ^
            ...
            {
                dwCRC = CrcTableOffset32[(dwCRC ^ pv[index]) & 0x000000FF] ^ (dwCRC >> 8);
                index++;
            }
